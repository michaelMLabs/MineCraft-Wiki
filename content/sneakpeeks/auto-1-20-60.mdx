...
date: "2024-02-06"
category: "sneakpeeks"
excerpt: "A new update for Minecraft is available now, bringing several changes, fixes, and experimental features! Check out the highlights from this release:Fixes to a whole bunch of bugs and parity changesExperimental features from the upcoming 1.21 update, includ"
