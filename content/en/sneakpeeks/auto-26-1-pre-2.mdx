...
category: "sneakpeeks"
excerpt: "Today we're shipping another pre-release for 26.1 that includes tech changes and fixes to features included in the Tiny Takeover game drop.Happy Friday mining!ChangesUpdated the dismount speed thresholds for Spears to match BedrockFixed issue with Baby Axo"
