...
-   [caves und `floating_islands` Geräuscheinstellungen erzeugen nicht mehr als beabsichtigt](https://bugs.mojang.com/browse/MC-310388)
-   [MC-310455](https://bugs.mojang.com/browse/MC-310455) - Ja. `copyTextureToBuffer` produziert gepolsterte Reihen mit dem OpenGL Rendering Backend, aber eng verpackte Reihen mit dem Vulkan
