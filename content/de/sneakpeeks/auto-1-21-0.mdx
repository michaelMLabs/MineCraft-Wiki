---
title: "1.21 Update - Tricky Trials"
date: "2024-06-13T15:52:56.884Z"
category: "sneakpeeks"
excerpt: "Neue Features:Added eine neue unterirdische Struktur namens die Trial ChambersAdded 2 neue mobsBreezeBoggedAdded eine neue Waffe, die MaceAdded 3 neue Zauber exklusiv für die MaceDensityBreachWind BurstAdded die folgenden Blöcke:CrafterTrial SpawnerOminous Tria"
cover: "https://launchercontent.mojang.com/v2/images/1.21.0.png"
tags: ["update", "1.21.0"]
_generated: true
_source: "https://launchercontent.mojang.com/v2/bedrockPatchNotes/cc4c9452ca14bf8d4e6af2d9cb3d37802f6db5d63c702128329e6f0dd887589c.json"
---
...
-   Meditative
-   Prairie Ride
-   Unpacked Added fifteen new paintings by artist Kristoffer Zetterstrand:
-   Backyard
-   Bouquet
-   Cavebird
-   Changing
...
Introducing the improved player Profile page, where you can see your own profile or the profiles of other players! In the new Profile screen, you can view achievement progress, compare stats, and access the dressing room, with more features coming later this year. This new screen will roll out slowly and become available in the coming weeks.
...
-   Getting to the new Profile Screen:
    ...
    See the [full 1.21 changelog](https://feedback.minecraft.net/hc/en-us/articles/27451789924237) for a full list of fixes and changes!
