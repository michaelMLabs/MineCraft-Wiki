...
-   Updated Add-On templates for 1.20.80 with new resources, behaviors, and documentation are available to download at [https://aka.ms/MCAddonPacks](https://aka.ms/MCAddonPacks)

For a full list of technical changes, see the [full changelog](https://feedback.minecraft.net/hc/en-us/articles/26107776674445).
